  ...
  return (
    <>
      ...
      <main id="content" className="relative" role="main">
        <section aria-labelledby="hero-heading" className="min-h-screen flex items-center justify-center pt-20">
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-500/10 px-4 py-1.5 text-sm text-cyan-300 mb-8 backdrop-blur-sm" role="banner">
              <span aria-label="India's first unified finance superapp">India's first unified finance superapp - broker‑agnostic platform</span>
            </div>
            <h1 id="hero-heading" className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-white mb-6">
            ...
            <div className="flex items-center justify-center gap-4" role="group" aria-label="Call to action buttons">
              ...
              <button 
                ...
                className="inline-flex items-center rounded-full px-8 py-3.5 text-base font-semibold border border-white/20 bg-white/5 text-white hover:bg-white/10 backdrop-blur-sm transition-all focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-950"
                aria-label="Get early access to broker agnostic trading app"
              >
                Get early access
              </button>
            </div>
            <p className="mt-8 text-xs text-slate-400 max-w-2xl mx-auto" role="note">
            ...
            <div className="mt-16">
              <p className="text-sm text-slate-400 mb-4">Built for India. Broker-agnostic unified finance.</p>
              <div className="flex items-center justify-center gap-3 flex-wrap" role="list" aria-label="Supported brokers for unified finance platform">
                <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-slate-400" role="listitem" aria-label="Angel One">AO</div>
                <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-slate-400" role="listitem" aria-label="Zerodha">Z</div>
                <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-slate-400" role="listitem" aria-label="Upstox">U</div>
                <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-slate-400" role="listitem" aria-label="ICICI Direct">IC</div>
                <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-slate-400" role="listitem" aria-label="HDFC Securities">HDFC</div>
                <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-slate-400" role="listitem" aria-label="5Paisa">5P</div>
                <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-slate-400" role="listitem" aria-label="Kotak Securities">K</div>
              </div>
            </div>
          </div>
        </section>

        <section id="features" aria-labelledby="features-heading" className="py-20 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <article className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 hover:border-cyan-500/50 transition-colors focus-within:border-cyan-500/50">
                <div className="text-3xl mb-3" role="img" aria-label="Unified Login Icon">🔗</div>
                <h3 className="font-semibold text-white mb-2 text-lg">Unified Login</h3>
                <p className="text-sm text-slate-300">Connect multiple brokers through our <strong>broker agnostic platform</strong> and use a single, consistent interface for all your trading needs.</p>
              </article>
              <article className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 hover:border-cyan-500/50 transition-colors focus-within:border-cyan-500/50">
                <div className="text-3xl mb-3" role="img" aria-label="Smart Trading Icon">⚡</div>
                <h3 className="font-semibold text-white mb-2 text-lg">Smart Trading</h3>
                <p className="text-sm text-slate-300">Lightning-fast, keyboard‑first order entry and quick actions for seamless <strong>unified finance</strong> trading experience.</p>
              </article>
              <article className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 hover:border-cyan-500/50 transition-colors focus-within:border-cyan-500/50">
                <div className="text-3xl mb-3" role="img" aria-label="Analytics Icon">📊</div>
                <h3 className="font-semibold text-white mb-2 text-lg">Deep Analytics</h3>
                <p className="text-sm text-slate-300">Comprehensive P&L tracking, win/loss analysis, heatmaps, and segment insights across all connected brokers.</p>
              </article>
              <article className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 hover:border-cyan-500/50 transition-colors focus-within:border-cyan-500/50">
                <div className="text-3xl mb-3" role="img" aria-label="Ledger Icon">📑</div>
                <h3 className="font-semibold text-white mb-2 text-lg">Ledger & Taxes</h3>
                <p className="text-sm text-slate-300">Broker‑synced ledger statements with CSV export for easy tax filing and portfolio management.</p>
              </article>
              <article className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 hover:border-cyan-500/50 transition-colors focus-within:border-cyan-500/50">
                <div className="text-3xl mb-3" role="img" aria-label="Alerts Icon">🔔</div>
                <h3 className="font-semibold text-white mb-2 text-lg">Real-time Alerts</h3>
                <p className="text-sm text-slate-300">Customizable price and event alerts via email or push notifications to never miss trading opportunities.</p>
              </article>
              <article className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 hover:border-cyan-500/50 transition-colors focus-within:border-cyan-500/50">
                <div className="text-3xl mb-3" role="img" aria-label="Customization Icon">🎛️</div>
                <h3 className="font-semibold text-white mb-2 text-lg">Full Customization</h3>
                <p className="text-sm text-slate-300">Personalize themes, layouts, and keyboard shortcuts to create your perfect <strong>unified finance</strong> workspace.</p>
              </article>
            </div>
          </div>
        </section>

        <section id="pricing" aria-labelledby="pricing-heading" className="py-20 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center">
              ...
              <div className="inline-block rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-8" role="status">
                <p className="text-slate-300">Pricing details coming soon. Get notified when we launch our competitive pricing plans.</p>
              </div>
            </header>
          </div>
        </section>

        <section id="security" aria-labelledby="security-heading" className="py-20 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-12">
              <h2 id="security-heading" className="text-3xl sm:text-4xl font-bold text-white mb-4">
                Security & Compliance
              </h2>
              <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <article className="flex gap-3">
                <div className="text-cyan-400 text-xl" aria-hidden="true">✓</div>
                <div>
                  <h3 className="font-semibold text-white mb-1 text-lg">Zero Password Storage</h3>
                  <p className="text-sm text-slate-300">You log in directly at your broker via secure OAuth authentication. We never store your broker passwords.</p>
                </div>
              </article>
              <article className="flex gap-3">
                <div className="text-cyan-400 text-xl" aria-hidden="true">✓</div>
                <div>
                  <h3 className="font-semibold text-white mb-1 text-lg">Scoped Permissions</h3>
                  <p className="text-sm text-slate-300">Only read/write trading access that you explicitly approve through our <strong>broker agnostic platform</strong>.</p>
                </div>
              </article>
              <article className="flex gap-3">
                <div className="text-cyan-400 text-xl" aria-hidden="true">✓</div>
                <div>
                  <h3 className="font-semibold text-white mb-1 text-lg">End-to-End Encryption</h3>
                  <p className="text-sm text-slate-300">HTTPS encryption in transit and AES-256 encryption at rest for all stored data and artifacts.</p>
                </div>
              </article>
              <article className="flex gap-3">
                <div className="text-cyan-400 text-xl" aria-hidden="true">✓</div>
                <div>
                  <h3 className="font-semibold text-white mb-1 text-lg">Privacy-First Analytics</h3>
                  <p className="text-sm text-slate-300">Analytics only with your explicit consent. No invasive tracking or data selling in our <strong>unified finance superapp</strong>.</p>
                </div>
              </article>
            </div>
            <p className="mt-8 text-center text-xs text-slate-400" role="note">
        ...
        <section id="faq" aria-labelledby="faq-heading" className="py-20 relative">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <details className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 hover:border-cyan-500/30 transition-colors group">
                <summary className="font-semibold text-white text-lg cursor-pointer list-none flex items-center justify-between">
                  ...
                  <span className="text-cyan-400 text-2xl group-open:rotate-180 transition-transform" aria-hidden="true">+</span>
                </summary>
        ...
        <section id="contact" aria-labelledby="contact-heading" className="py-20 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              <header className="text-center mb-12">
                <h2 id="contact-heading" className="text-3xl sm:text-4xl font-bold text-white mb-4">Contact Us</h2>
                <p className="text-lg text-slate-400">Support, partnerships, media — we're here to help with our <strong>unified finance platform</strong>.</p>
              </header>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-8">
                <form className="space-y-5" aria-label="Contact form">
                  <div>
                    ...
                    <input 
                      ...
                      required
                      aria-required="true"
                      className="w-full rounded-lg border border-slate-700 bg-slate-800 px-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all" 
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      required
                      aria-required="true"
                      className="w-full rounded-lg border border-slate-700 bg-slate-800 px-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all resize-none" 
                    />
                  </div>
                  <button 
                    type="submit"
                ...
                <div className="mt-8 pt-8 border-t border-slate-800">
                  <p className="text-sm text-slate-300">
                    Prefer email? <a href="mailto:support@unifyn.trade" className="text-cyan-400 hover:text-cyan-300 transition-colors underline">support@unifyn.trade</a>
                  </p>
                  <address className="mt-2 not-italic text-sm text-slate-400">
