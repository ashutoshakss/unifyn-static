  ...
  return (
    <ModalContext.Provider value={value}>
          ...
          <div className={`relative bg-gradient-to-br from-slate-900/95 to-slate-800/95 rounded-3xl shadow-2xl shadow-cyan-500/10 w-full max-w-lg border border-slate-700/50 backdrop-blur-xl transform transition-all duration-300 ${openName === 'login' ? 'scale-100' : 'scale-95'}`}>
            ...
            <div className="relative px-8 py-8">
              <div className="mb-6">
                ...
                <p className="text-sm text-slate-400">Sign in to your account to continue trading</p>
              </div>
              
              {/* Social Login Buttons */}
              <div className="space-y-3 mb-6">
                <button className="group w-full flex items-center justify-center gap-3 rounded-xl border border-slate-700/50 bg-slate-800/50 hover:bg-slate-700/50 hover:border-cyan-500/50 px-5 py-3.5 transition-all duration-200">
                  ...
                  <span className="font-medium text-slate-200 group-hover:text-white transition-colors">Continue with Google</span>
                </button>
                ...
                <button className="group w-full flex items-center justify-center gap-3 rounded-xl border border-slate-700/50 bg-slate-800/50 hover:bg-slate-700/50 hover:border-cyan-500/50 px-5 py-3.5 transition-all duration-200">
                  ...
                  <span className="font-medium text-slate-200 group-hover:text-white transition-colors">Continue with Apple</span>
                </button>
              </div>
              ...
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); }}>
                <div>
                  <label htmlFor="login-mobile" className="block text-xs font-medium text-slate-400 mb-2 uppercase tracking-wide">Mobile Number</label>
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full rounded-xl border border-slate-700/50 bg-slate-800/50 pl-14 pr-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 transition-all" 
                    />
                  </div>
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-slate-700/50 text-center">
                <p className="text-sm text-slate-400">
                  Don't have an account? <button data-open-modal="signup" className="text-cyan-400 hover:text-cyan-300 transition-colors font-medium">Sign up</button>
                </p>
              </div>
              ...
              <div className="mt-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed">We use secure authentication. Your data is protected. Read our <a href="/privacy" className="text-cyan-400 hover:text-cyan-300 transition-colors">Privacy Policy</a>.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-md" data-close-modal></div>
        <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-8">
          <div className={`relative bg-gradient-to-br from-slate-900/95 to-slate-800/95 rounded-3xl shadow-2xl shadow-cyan-500/10 w-full max-w-lg border border-slate-700/50 backdrop-blur-xl transform transition-all duration-300 ${openName === 'connect-broker' ? 'scale-100' : 'scale-95'}`}>
            <button data-close-modal className="absolute top-4 right-4 z-50 w-10 h-10 rounded-full bg-slate-800/50 hover:bg-slate-700 text-slate-400 hover:text-white transition-all flex items-center justify-center group" aria-label="Close">
              <svg className="w-5 h-5 group-hover:rotate-90 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"/></svg>
            </button>
            <div className="relative px-8 py-8">
